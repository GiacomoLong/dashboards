...
# ── Legenda dinamica — mostra solo layer attivi ──────────
voci_legenda = []
...
if show_park:
    voci_legenda.append(
        ...
        "<span style='font-size:13px;color:#444'>🌳 Parchi</span></div>"
    )
if show_garden:
    voci_legenda.append(
        "<div style='display:flex;align-items:center;margin-bottom:8px'>"
        "<div style='width:28px;height:16px;background:#ce93d8;border-radius:4px;"
        "margin-right:10px;border:2px solid #7b2d8b'></div>"
        "<span style='font-size:13px;color:#444'>🌸 Giardini</span></div>"
    )
if show_swimming:
    voci_legenda.append(
        "<div style='display:flex;align-items:center;margin-bottom:8px'>"
        ...
        "<span style='font-size:13px;color:#444'>🏊 Aree Nuoto</span></div>"
    )
if show_pool:
    voci_legenda.append(
        "<div style='display:flex;align-items:center;margin-bottom:8px'>"
        "<div style='width:28px;height:16px;background:#caf0f8;border-radius:4px;"
        "margin-right:10px;border:2px solid #0096c7'></div>"
        "<span style='font-size:13px;color:#444'>🏊 Piscine Pubbliche</span></div>"
    )
if show_drinking:
    voci_legenda.append(
        "<div style='display:flex;align-items:center;margin-bottom:8px'>"
        "<span style='font-size:18px;margin-right:8px'>💧</span>"
        "<span style='font-size:13px;color:#444'>Fontanelle</span></div>"
    )
if show_library:
    voci_legenda.append(
        "<div style='display:flex;align-items:center;margin-bottom:8px'>"
        "<span style='font-size:18px;margin-right:8px'>📚</span>"
        "<span style='font-size:13px;color:#444'>Biblioteche</span></div>"
    )
if show_pharmacy:
    voci_legenda.append(
        "<div style='display:flex;align-items:center;margin-bottom:8px'>"
        "<span style='font-size:18px;margin-right:8px'>💊</span>"
        "<span style='font-size:13px;color:#444'>Farmacie</span></div>"
    )
if show_shelter:
    voci_legenda.append(
        "<div style='display:flex;align-items:center;margin-bottom:8px'>"
        "<span style='font-size:18px;margin-right:8px'>⛺</span>"
        "<span style='font-size:13px;color:#444'>Ripari</span></div>"
    )
...
<div style="
    ...
    <div style="display:flex; align-items:center; margin-bottom:8px;">
        <div style="width:28px; height:4px; background:#e63946;
                    border-radius:2px; margin-right:10px;
                    border:1px dashed #e63946;"></div>
